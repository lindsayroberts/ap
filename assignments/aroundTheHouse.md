...
Open a text editor and create a file called ‘house’ (be sure that the file extension is either .doc, .docx, .pdf, or .txt). In no more than 400 words[1], describe this device in detail. You may wish to consider questions such as:
